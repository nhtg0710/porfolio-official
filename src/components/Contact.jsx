      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
            I&apos;m always excited to discuss opportunities, collaborations, or
            your next big idea. Whether you&apos;re looking for a creative mind
            to bring your project to life, need a problem solver for complex
            challenges, or just want to chat about software development and
        ...
        <form
          action="https://getform.io/f/aollzvpb"
          className="xl:pl-10 2xl:pl-20 "
          method="POST"
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            <div className="mb-4">
              {/* //TODO explain the label and form thing, how it works */}
